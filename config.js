...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || '07_13_H_E_R_M_I_T_BGBDWMP',
    ...
    BOT_NAME: process.env.BOT_NAME || '★Slade Bot★',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Tsepo;Mohlomi;27736267768;https://i.imgur.com/6oRG106.jpeg',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,

    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'tsepo;Slade' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '27736267768,0',
